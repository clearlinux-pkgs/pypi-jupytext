...
Provides: jupytext
Provides: jupytext-python
Provides: jupytext-python3
...
%prep
%setup -q -n jupytext-1.13.2
cd %{_builddir}/jupytext-1.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641451945
...
cp %{_builddir}/jupytext-1.13.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupytext/1231263eb0ac529b5c53cfded54019bd4280729f
cp %{_builddir}/jupytext-1.13.2/packages/labextension/LICENSE %{buildroot}/usr/share/package-licenses/pypi-jupytext/6070800810da89afd1bfd1d32e40f9cb79531c0e
...
/usr/share/package-licenses/pypi-jupytext/1231263eb0ac529b5c53cfded54019bd4280729f
