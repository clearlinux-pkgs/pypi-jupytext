...
Version  : 1.14.5
Release  : 21
URL      : https://files.pythonhosted.org/packages/0a/7f/c495114a3814df1d9d41855e939a6a0cb133a1a11a34a22bde934d115ff4/jupytext-1.14.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/0a/7f/c495114a3814df1d9d41855e939a6a0cb133a1a11a34a22bde934d115ff4/jupytext-1.14.5.tar.gz
...
%prep
%setup -q -n jupytext-1.14.5
cd %{_builddir}/jupytext-1.14.5
pushd ..
cp -a jupytext-1.14.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677368542
